...
def main():
    ...
    # For loop to loop through from 50-54.
    for i in range(50, 55):
        # Prints the interpolated values
        print(multiple_interpolation(change_x, change_y, change_z, init_x, init_y, init_z, i - initial_time,
                                     initial_time))


# If this is the file that's run, call main.
